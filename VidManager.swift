...
//  VideoPlayerDemo
//
//  Created by Daniel Wade Duggin on 2/2/23.
//

import Foundation
enum Query: String, CaseIterable{
    case Welcome, Dining, Recreation, Map, Jenni
}

class VidManager: ObservableObject {
    @Published private(set) var videos: [Video] = []
    @Published var selectedQuery: Query = Query.Dining {
    ...
    func findVideos(topic: Query) async {
        ...
        urlRequest.setValue("74asMS0aPs1hqytwh22ZtREZlYggyU8mQdAbSwqi1opmQIptckcXIzn8", forHTTPHeaderField: "Authorization")
